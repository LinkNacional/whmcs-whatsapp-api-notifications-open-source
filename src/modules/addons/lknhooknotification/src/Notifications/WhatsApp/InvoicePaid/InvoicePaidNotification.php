...
namespace Lkn\HookNotification\Notifications\WhatsApp\InvoicePaid;
 ...
 * @since 3.3.0
 */
final class InvoicePaidNotification extends AbstractWhatsAppNotifcation
{
    public string $notificationCode = 'InvoicePaid';

    /**
     * @var \Lkn\HookNotification\Config\Hooks|array|null
     * @link https://developers.whmcs.com/hooks-reference/cron/#dailycronjob
     */
    public Hooks|array|null $hook = Hooks::INVOICE_PAID;
