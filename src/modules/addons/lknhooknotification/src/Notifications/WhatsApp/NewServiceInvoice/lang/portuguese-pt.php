...
$lang['notification_title'] = 'Nova fatura de serviço';
$lang['notification_description'] = 'Esta notificação é enviada quando uma nova fatura para um serviço existente é emitida. Faturas de pedidos não contam.';
