...
namespace Lkn\HookNotification\Core\Shared\Infrastructure\Interfaces {
    class BaseController
    {
        ...
        protected \Lkn\HookNotification\Core\Shared\Infrastructure\View\View $view;
...
namespace Lkn\HookNotification\Core\Platforms\MetaWhatsApp\Application {
    final class MetaWhatsAppService
    {
        ...
        public function getMessageTemplatesForView()
        {
        }
    }
}
...
namespace Lkn\HookNotification\Core\Notification\Http\Controllers {
    final class NotificationController extends \Lkn\HookNotification\Core\Shared\Infrastructure\Interfaces\BaseController
    {
        ...
        public function viewNotificationsTable(array $request): string
        {
        }
    }
}
...
namespace Lkn\HookNotification\Core\Notification\Application\Services {
    final class NotificationService
    {
        ...
        public function buildNotification(string $notificationCode)
        {
        }
    ...
    final class NotificationSender extends \Lkn\HookNotification\Core\Shared\Infrastructure\Singleton
    {
         ...
         */
        public function send(\Lkn\HookNotification\Core\Notification\Domain\AbstractNotification $notification, ?array $whmcsHookParams): \Lkn\HookNotification\Core\Shared\Infrastructure\Result|\Lkn\HookNotification\Core\Platforms\Common\PlatformNotificationSendResult
        {
        }
    }
    final class NotificationViewService
    {
        ...
        public function getTemplateEditorForPlatform(\Lkn\HookNotification\Core\Notification\Domain\AbstractNotification $notification, ?\Lkn\HookNotification\Core\Notification\Domain\NotificationTemplate $template): string
        {
        }
    }
}
...
namespace Lkn\HookNotification\Core\Notification\Infrastructure\NotificationTemplateRenderers {
    final class MetaWhatsAppTemplateRenderer
    {
        ...
        public function render(\Lkn\HookNotification\Core\Notification\Domain\AbstractNotification $notificationTemplate, ?\Lkn\HookNotification\Core\Notification\Domain\NotificationTemplate $template): string
        {
        }
    }
}
...
namespace Lkn\HookNotification\Core\Notification\Domain {
    ...
    {
        public readonly array $whmcsHookParams;
        public readonly \Lkn\HookNotification\Core\Notification\Domain\Client $client;
    ...
    final class Client
    {
        ...
        public function setWhatsAppPhoneNumber(int $customFieldId): void
        {
        }
        public function validateWpPhoneNumber(): false|string
        {
        }
...
namespace Lkn\HookNotification\Core\NotificationReport\Http\Controllers {
    final class NotificationReportController extends \Lkn\HookNotification\Core\Shared\Infrastructure\Interfaces\BaseController
    {
        ...
        public function viewReports(array $request)
        {
        }
    }
}
...
namespace Lkn\HookNotification\Core\Shared\Application {
    ...
    final class SettingsService
    {
         ...
         * @param  Platforms   $platform
         * @param  string|null $subpage
         * @param  array       $incomingSettings [Settings::->value => newValue]
         *
...
namespace Lkn\HookNotification\Core\Shared\Infrastructure\Repository {
    ...
    {
        public function getCustomField(int $clientId, int $customFieldId): mixed
        {
        }
        public function getWhmcsPhoneNumber(int $clientId): mixed
        {
        }
        public function getClientCountry(int $clientId): mixed
        {
        }
        /**
         * @param  integer $clientId
         *
         * @return array [locale => pt_BR, langCode => pt]
         */
        public function getClientLang(int $clientId): mixed
        {
        }
    }
}
...
namespace Lkn\HookNotification\Core\Shared\Infrastructure {
    class Result
    {
        public function __construct(public ?string $code = null, public ?array $data = null, public ?string $msg = null, public ?array $errors = [], public readonly null|bool $operationResult = null)
        {
        }
        public function toArray(): array
        {
...
namespace Lkn\HookNotification\Core\Shared\Infrastructure\View {
    ...
    final class View
    {
         ...
         * @return string
         */
        public function view(string $filename, array $params = []): string
        {
        }
    }
}
...
namespace {
    ...
    function getInvoicePdfUrlByInvocieId(int $id, bool $returnNullOtherwise = \false): ?string
    {
    }
    /**
    ...
    function lkn_hn_get_client_custom_fields_for_view()
    {
    }
